...
-- CAL-5557, CAL-5465, CAL-6448
DROP FUNCTION callrec.add_couple(integer, timestamp with time zone, timestamp with time zone, inet, inet, character varying, character varying, character varying, character varying, character varying, cpltype, problemstatus, character varying);
...
ALTER FUNCTION callrec.add_couple(callrec.couples.callid%TYPE,
                                      ...
                                      callrec.couples.direction%TYPE,
                                      callrec.couples.dayofweek%TYPE,
                                      callrec.couples.timeofday%TYPE) OWNER TO postgres;
GRANT EXECUTE ON FUNCTION callrec.add_couple(callrec.couples.callid%TYPE,
                                      callrec.couples.start_ts%TYPE,
                                      callrec.couples.stop_ts%TYPE,
                                      callrec.couples.callingip%TYPE,
                                      ...
                                      callrec.couples.direction%TYPE,
                                      callrec.couples.dayofweek%TYPE,
                                      callrec.couples.timeofday%TYPE) TO postgres;
GRANT EXECUTE ON FUNCTION callrec.add_couple(callrec.couples.callid%TYPE,
                                      callrec.couples.start_ts%TYPE,
                                      callrec.couples.stop_ts%TYPE,
                                      callrec.couples.callingip%TYPE,
                                      ...
                                      callrec.couples.direction%TYPE,
                                      callrec.couples.dayofweek%TYPE,
                                      callrec.couples.timeofday%TYPE) TO  callrecgrp;
