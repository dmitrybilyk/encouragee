...
CREATE OR REPLACE FUNCTION callrec.DECODE_STREAMGROUP(callrec.couples.id%TYPE,
  ...
  AS '
    ...
    _restored     ALIAS FOR $13;
      _direction  ALIAS FOR $14;
      _cfid     callrec.cfiles.id%TYPE;
    BEGIN
      _cfid := callrec.ADD_CFILE(_cplid, _sgid, _bytes, _cktype, _ckvalue, _newtype, _newpath, _enc_key_id, _digest, _start_ts, _stop_ts, _archived, _restored, null, _direction);
